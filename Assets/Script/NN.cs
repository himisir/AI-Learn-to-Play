...
public class NN : MonoBehaviour
{
    ...
    public Matrix<float> inputLayer = Matrix<float>.Build.Dense(1, 1);
    ...
    public void Initialize(int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for (int i = 0; i < hiddenLayerCount + 1; i++)
        {
            ...
            if (i == 0)
            {
                Matrix<float> inputToH1 = Matrix<float>.Build.Dense(1, hiddenNeuronCount);
    ...
    public NN InitializeCopy(int hiddenLayerCount, int hiddenNeuronCount)
    {
        NN n = new NN();
    ...
    public (float, float) RunNN(float a)
    {
        inputLayer[0, 0] = a;
